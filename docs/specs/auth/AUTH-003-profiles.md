...
## Objetivo
Aplicar perfis do 7Eventos em menus, ações e serviços.

## Escopo
Superadmin, Admin, Gestor, Operador e Consulta.
...
## Backend/Domínio
A interface reflete permissões, mas backend também valida autorização.
...
## Critérios de aceite
- [ ] AC01 Perfil Consulta não altera dados
- [ ] AC02 Admin gerencia recursos autorizados
- [ ] AC03 Acesso direto não contorna permissão
