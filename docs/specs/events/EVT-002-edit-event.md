...
## Objetivo
Permitir alteração controlada de evento existente.

## Escopo
Dados editáveis da Fase 1 e histórico de mudanças relevantes.
...
## Backend/Domínio
Não permitir edição cross-tenant ou sem perfil.
...
## Critérios de aceite
- [ ] AC01 Edição autorizada persiste
- [ ] AC02 Mudanças relevantes auditadas
- [ ] AC03 Acesso indevido negado
