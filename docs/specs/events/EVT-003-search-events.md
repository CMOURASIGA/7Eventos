...
## Objetivo
Localizar eventos por filtros definidos no produto.

## Escopo
Título, demandante, período, status, complexidade, local, temática e estratégico.
...
## Backend/Domínio
Não exibir nenhum resultado antes da primeira busca.
...
- [ ] AC02 Resultados respeitam tenant
- [ ] AC03 Estado inicial correto
- [ ] AC04 Ações respeitam perfil
