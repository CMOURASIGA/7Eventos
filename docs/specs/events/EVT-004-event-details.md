...
## Objetivo
Exibir visão consolidada do evento.

## Escopo
Dados gerais, sessões, localização, planejamento, reservas, checklist, orçamento, complexidade e histórico disponíveis.
...
## Backend/Domínio
Somente dados autorizados e existentes.
...
## Critérios de aceite
- [ ] AC01 Detalhe consolida módulos disponíveis
- [ ] AC02 Sem vazamento cross-tenant
- [ ] AC03 Estados de loading/erro tratados
