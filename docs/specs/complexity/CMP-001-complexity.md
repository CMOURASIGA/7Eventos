...
## Objetivo
Calcular e registrar complexidade a partir de esforço e impacto.

## Escopo
Fatores previstos na especificação do produto.
...
## Backend/Domínio
Fórmula centralizada, configurável e auditável; não espalhar cálculo na UI.
...
## Critérios de aceite
- [ ] AC01 Resultado deriva dos fatores
- [ ] AC02 Fatores usados são preservados
- [ ] AC03 Cálculo é testável fora da UI
