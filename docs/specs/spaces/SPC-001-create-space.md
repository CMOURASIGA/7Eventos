...
## Objetivo
Cadastrar espaços reserváveis da empresa.

## Escopo
Nome, local, capacidade, status, descrição, características, equipamentos e observações.
...
## Backend/Domínio
Espaço pertence ao tenant; validar obrigatórios e limites.
...
## Critérios de aceite
- [ ] AC01 Cadastro válido persiste
- [ ] AC02 Capacidade inválida é rejeitada
- [ ] AC03 Tenant correto é aplicado
