# PLN-001 - Checklist e planejamento
...
## Objetivo
Gerenciar itens operacionais vinculados ao evento.

## Escopo
Título, categoria, responsável, prazo, status, observação e conclusão.
...
## Backend/Domínio
Calcular percentual de conclusão e respeitar permissões.
...
## Critérios de aceite
- [ ] AC01 CRUD autorizado funciona
- [ ] AC02 Percentual é consistente
- [ ] AC03 Status suportados funcionam
- [ ] AC04 Tenant preservado
