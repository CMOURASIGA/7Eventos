...
## Objetivo
Exibir eventos e sessões em calendário, lista e eventos do dia.

## Escopo
Navegação por período, hoje, filtros e acesso ao detalhe.
...
## Backend/Domínio
Agenda usa dados reais e respeita tenant.
...
## Critérios de aceite
- [ ] AC01 Calendário reflete sessões
- [ ] AC02 Lista reflete filtros
- [ ] AC03 Eventos do dia corretos
- [ ] AC04 Acesso ao detalhe funciona
