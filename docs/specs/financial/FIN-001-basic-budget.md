...
## Objetivo
Registrar previsão orçamentária da Fase 1.

## Escopo
Previsto no orçamento, valor previsto, observação e status.
...
## Backend/Domínio
Não implementar realizado/fornecedores/pagamentos da Fase 2.
...
## Critérios de aceite
- [ ] AC01 Valor previsto pode ser registrado
- [ ] AC02 Dashboard distingue com/sem orçamento
- [ ] AC03 Escopo não antecipa Fase 2
