...
export interface NavItem {
  label: string;
  href: string;
  icon: "dashboard" | "calendar" | "events" | "spaces" | "reservations" | "reports" | "audit" | "users" | "suppliers" | "participants";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Participantes", href: "/participantes", icon: "participants", section: "Gestão", capability: "view_event" },
